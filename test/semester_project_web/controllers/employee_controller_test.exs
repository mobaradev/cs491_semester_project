defmodule SemesterProjectWeb.EmployeeControllerTest do
  ...
  @create_attrs %{date_of_hire: "some date_of_hire", department: "some department", employee_id: 42, first_name: "some first_name", last_name: "some last_name"}
  ...
  describe "update employee" do
    ...
    test "redirects when data is valid", %{conn: conn, employee: employee} do
      ...
      assert html_response(conn, 200) =~ "some updated date_of_hire"
    end
