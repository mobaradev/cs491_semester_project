defmodule SemesterProject.HumanResourcesTest do
  ...
  describe "employees" do
    ...
    test "create_employee/1 with valid data creates a employee" do
      valid_attrs = %{date_of_hire: "some date_of_hire", department: "some department", employee_id: 42, first_name: "some first_name", last_name: "some last_name"}

      assert {:ok, %Employee{} = employee} = HumanResources.create_employee(valid_attrs)
      assert employee.date_of_hire == "some date_of_hire"
    ...
    test "update_employee/2 with valid data updates the employee" do
      employee = employee_fixture()
      update_attrs = %{date_of_hire: "some updated date_of_hire", department: "some updated department", employee_id: 43, first_name: "some updated first_name", last_name: "some updated last_name"}

      assert {:ok, %Employee{} = employee} = HumanResources.update_employee(employee, update_attrs)
      assert employee.date_of_hire == "some updated date_of_hire"
